...
public class RLPlayer03 implements IPlayer{
/* ---------------- Variables ---------------- */
	...
	//
/* ---------------- Constructor ---------------- */	  
	public RLPlayer03(int ident, byte boardSize, byte baseSize, byte numberOfPawns) {
		this.color = ident;
		this.turn = ident;
		this.playerType =  Settings.RL3_PLAYER;
